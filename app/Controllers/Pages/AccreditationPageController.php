...
class AccreditationPageController
{
    ...
    function index(QuizApiService $quizApiService, int $id)
    {
        ...
        $_argDto = $quizApiService->getTopic(ExamType::Bronze, 8, 120);
        $_argDto_silver = $quizApiService->getTopic(ExamType::Silver, 16, 240);
        $_argDto_gold = $quizApiService->getTopic(ExamType::Gold, 24, 360);
