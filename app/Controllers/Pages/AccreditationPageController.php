...
class AccreditationPageController
{
    ...
    function index(QuizApiService $quizApiService, int $id)
    {
        ...
        $_argDto = $quizApiService->getTopic(ExamType::Bronze, 10, 150);
        $_argDto_silver = $quizApiService->getTopic(ExamType::Silver, 20, 300);
        $_argDto_gold = $quizApiService->getTopic(ExamType::Gold, 30, 450);
