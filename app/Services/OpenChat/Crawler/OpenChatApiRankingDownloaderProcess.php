...
class OpenChatApiRankingDownloaderProcess implements OpenChatApiRankingDownloaderProcessInterface
{
    ...
    function fetchOpenChatApiRankingProcess(string $category, string $ct, \Closure $callback): array|false
    {
         ...
         */
        $url = OpenChatCrawlerConfig::generateOpenChatApiRankigDataUrl($category, $ct);
