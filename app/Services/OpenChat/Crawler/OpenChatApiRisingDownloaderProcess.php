...
class OpenChatApiRisingDownloaderProcess implements OpenChatApiRankingDownloaderProcessInterface
{
    ...
    function fetchOpenChatApiRankingProcess(string $category, string $ct, \Closure $callback): array|false
    {
         ...
         */
        $url = OpenChatCrawlerConfig::generateOpenChatApiRisingDataUrl($category, $ct);
