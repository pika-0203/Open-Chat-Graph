...
class OpenChatImgDownloader
{
     ...
     */
    function storeOpenChatImg(string $openChatImgIdentifier, string $destPath): bool
    {
        /**
        ...
        $this->store(
            $url,
            "{$destPath}/{$openChatImgIdentifier}.webp",
            OpenChatCrawlerConfig::STORE_IMG_QUALITY,
        );

        $this->store(
            $previewUrl,
            "{$destPath}/preview/{$openChatImgIdentifier}_p.webp",
            OpenChatCrawlerConfig::STORE_IMG_QUALITY,
        );
