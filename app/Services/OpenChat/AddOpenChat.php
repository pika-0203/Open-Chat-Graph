...
class AddOpenChat
{
    ...
    function add(string $url): array
    {
        ...
        if ($existingOpenChatId !== false) {
            ...
            $this->logRepository->logAddOpenChatDuplicationError($existingOpenChatId, $openChatIdentifier, getIP(), getUA());
            return $this->exitingOpenChatMessage($existingOpenChatId);
        }
        ...
        $this->logRepository->logAddOpenChat($openChatId, getIP(), getUA());
