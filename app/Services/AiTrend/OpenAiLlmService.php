...
```json
{
  \"summary\": \"6つの解析手法による厳選チャット・タグの戦略的価値、統計的異常値から発見された隠れた市場機会、LINEオープンチャット生態系の長期的構造変化、競争環境分析に基づく新規参入機会、外部要因（社会情勢・技術進化）を考慮した将来予測、実用的なマーケティング戦略への応用方法を統合した包括的分析サマリー\"
}
```
...
### 🌐 外部情報活用の重点領域
- 関連する社会トレンド（Z世代文化、働き方改革等）
- 競合プラットフォームの動向
- LINE公式の機能アップデート情報
- 経済指標とコミュニティ形成の相関性
- インフルエンサー・メディアでの話題性

サマリーは単なる集計ではなく、隠れた市場機会と長期的価値を発見し、実用的な戦略提案を含む戦略的分析レポートとして作成してください。
";
    }
