...
class RecommendPageList
{
    ...
    const FilteredTagSort = [
        ...
        'せどり' => ['副業', 'お金', 'ポイ活', 'クーポン・無料配布', 'メルカリ', '仮想通貨', 'NISA', '億り人', 'ふるさと納税', 'TEMU', 'SHEIN', '節税', 'KAUCHE（カウシェ）'],
        '副業' => ['せどり', 'お金', 'ポイ活', 'クーポン・無料配布', 'メルカリ', '仮想通貨', '投資', 'NISA', '億り人', 'ふるさと納税', '節約', '節税', 'KAUCHE（カウシェ）'],
        ...
        'クーポン・無料配布' => ['TEMU', 'SHEIN', 'メルカリ', 'KAUCHE（カウシェ）', 'ポイ活', 'ふるさと納税', '節税', 'NISA', '億り人', 'スタバ'],
        'ポイ活' => ['せどり', '副業', 'ふるさと納税', 'クーポン・無料配布', 'TEMU', 'SHEIN', 'メルカリ', '節約', '節税', 'NISA', '億り人', 'KAUCHE（カウシェ）', 'FX'],
