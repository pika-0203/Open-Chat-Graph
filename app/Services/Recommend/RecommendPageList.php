...
class RecommendPageList
{
    ...
    const FilteredTagSort = [
        ...
        '学生限定' => ['小学生・中学生限定', '中学生・高校生限定', '中学生限定', '高校生限定', '中学生', '高校生', '男子限定', '女子限定', '雑談', 'ボイメで歌（歌リレー）', '恋バナ'],
        '小学生・中学生限定' => ['学生限定', '中学生・高校生限定', '中学生限定', '中学生', '男子限定', '女子限定', '雑談', 'ボイメで歌（歌リレー）', '恋バナ'],
        '中学生・高校生限定' => ['小学生・中学生限定', '学生限定', '中学生限定', '高校生限定', '中学生', '高校生', '男子限定', '女子限定', '雑談', 'ボイメで歌（歌リレー）', '恋バナ'],
        '中学生限定' => ['小学生・中学生限定', '学生限定', '中学生・高校生限定', '中学生', '男子限定', '女子限定', '雑談', 'ボイメで歌（歌リレー）', '恋バナ'],
        '高校生限定' => ['中学生・高校生限定', '学生限定', '高校生', '男子限定', '女子限定', '雑談', 'ボイメで歌（歌リレー）', '恋バナ'],
        '中学生' => ['小学生・中学生限定', '中学生限定', '中学生・高校生限定', '学生限定', '男子限定', '女子限定', '雑談', '恋バナ'],
        '高校生' => ['中学生・高校生限定', '学生限定', '高校生限定', '男子限定', '女子限定', '雑談', 'ボイメで歌（歌リレー）', '恋バナ'],
        '男子限定' => ['小学生・中学生限定', '中学生限定', '中学生・高校生限定', '学生限定', '高校生限定', '中学生', '高校生', '雑談', 'ボイメで歌（歌リレー）'],
        '女子限定' => ['小学生・中学生限定', '中学生限定', '中学生・高校生限定', '学生限定', '高校生限定', '中学生', '高校生', '雑談', 'ボイメで歌（歌リレー）', '恋バナ'],
