...
class RecommendPageList
{
    ...
    const FilteredTagSort = [
        ...
        'マインクラフト（マイクラ）' => ['ゲーム', 'ぷにぷに', 'ONE PIECE バウンティラッシュ', 'カーパーキング', 'ロブロックス', 'ブロスタ'],
        ...
        'ポケモンGO' => ['ポケモン スカーレット・バイオレット（ポケモンSV）', 'ポケモン', 'ポケモンスリープ', 'ポケモンユナイト', 'ポケモンカード（ポケカ）'],
        'ポケモン スカーレット・バイオレット（ポケモンSV）' => ['ポケモンGO', 'ポケモン', 'ポケモンスリープ', 'ポケモンユナイト', 'ポケモンカード（ポケカ）'],
