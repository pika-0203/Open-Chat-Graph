...
class RecommendPageList
{
    ...
    const FilteredTagSort = [
        ...
        '恋愛相談' => ['恋愛', '垢抜け', '失恋', 'メンタルヘルス', '雑談', '学生限定', '愚痴'],
        '恋バナ' => ['恋愛', '垢抜け', '失恋', '恋愛相談', 'メンタルヘルス', '雑談', '学生限定', '愚痴'],
        '恋愛' => ['恋愛', 'メンタルヘルス', '雑談', '学生限定', '愚痴'],
        'ライブトーク' => ['恋愛', '恋バナ', '失恋', 'メンタルヘルス', '雑談', '学生限定', '愚痴', 'ボイメで歌（歌リレー）'],
        '失恋' => ['メンタルヘルス', '雑談', '学生限定', '恋愛', '恋愛相談', '恋話', '愚痴'],
        '学生限定' => ['小学生・中学生限定', '中学生・高校生限定', '中学生限定', '高校生限定', '中学生', '高校生', '男子限定', '女子限定', '雑談', 'ボイメで歌（歌リレー）'],
        '小学生・中学生限定' => ['学生限定', '中学生・高校生限定', '中学生限定', '中学生', '男子限定', '女子限定', '雑談', 'ボイメで歌（歌リレー）'],
        '中学生・高校生限定' => ['小学生・中学生限定', '学生限定', '中学生限定', '高校生限定', '中学生', '高校生', '男子限定', '女子限定', '雑談', 'ボイメで歌（歌リレー）'],
        '中学生限定' => ['小学生・中学生限定', '学生限定', '中学生・高校生限定', '中学生', '男子限定', '女子限定', '雑談', 'ボイメで歌（歌リレー）'],
        '高校生限定' => ['中学生・高校生限定', '学生限定', '高校生', '男子限定', '女子限定', '雑談', 'ボイメで歌（歌リレー）'],
        '中学生' => ['小学生・中学生限定', '中学生限定', '中学生・高校生限定', '学生限定', '男子限定', '女子限定', '雑談'],
        '高校生' => ['中学生・高校生限定', '学生限定', '高校生限定', '男子限定', '女子限定', '雑談', 'ボイメで歌（歌リレー）'],
        '男子限定' => ['小学生・中学生限定', '中学生限定', '中学生・高校生限定', '学生限定', '高校生限定', '中学生', '高校生', '雑談', 'ボイメで歌（歌リレー）'],
        '女子限定' => ['小学生・中学生限定', '中学生限定', '中学生・高校生限定', '学生限定', '高校生限定', '中学生', '高校生', '雑談', 'ボイメで歌（歌リレー）'],
        '雑談' => ['中学生限定', '中学生・高校生限定', '学生限定', '高校生限定', '大学生', 'ボイメで歌（歌リレー）', '愚痴', '恋バナ', 'メンタルヘルス', '恋愛相談', '大喜利'],
