...
class RecommendTagFilters
{
    ...
    const FilteredTagSort = [
        ...
        '40代' => ['大人', '30代', '50代', '60代', '70代', '全国 雑談', '即承認', '雑談', 'ライブトーク', '宣伝'],
        '50代' => ['大人', '40代', '60代', '70代', '全国 雑談', '即承認', '雑談', 'ライブトーク', '宣伝', 'NISA'],
        '60代' => ['大人', '40代', '50代', '70代', '全国 雑談', '即承認', '雑談', 'ライブトーク', '宣伝', 'NISA'],
        '70代' => ['大人', '40代', '50代', '60代', '全国 雑談', '即承認', '雑談', 'ライブトーク', '宣伝', 'NISA'],
        '全国 雑談' => ['大人', '20代', '30代', '40代', '50代', '60代', '70代', '即承認', '雑談', '雑談', 'ライブトーク', '愚痴', '宣伝'],
        'オフ会' => ['大人', 'リア充', 'ネッ友', '雑談', 'ライブトーク', '愚痴', '宣伝'],
        '即承認' => ['大人', '20代', '30代', '40代', '50代', '60代', '70代', '全国 雑談', '雑談', 'ライブトーク'],
        'アニメ' => ['アニソン'],
        ...
        'スマホ' => ['SNS', '写真投稿', 'ゲーム', 'パソコン・ガジェット', '編集', 'イラスト', 'ポイ活', 'カメラ', 'ONE PIECE バウンティラッシュ'],
        ...
        '宣伝' => ['学生限定', 'ボイメで歌（歌リレー）', '愚痴', '恋バナ', 'メンタルヘルス', '恋愛相談', 'ライブトーク', '大人', '雑談'],
