...
class RecommendUpdater
{
    const NAME_STRONG_TAG = [
        ...
        ["就活生情報・選考対策・企業研究", ["就活情報_OR_就活生向け情報_OR_就活生情報_OR_選考対策・企業研究_OR_就活選考対策_OR_就活対策グループ_OR_就活テスト対策グループ_OR_志望者向けグループ_OR_業界志望者向け_OR_就活の情報_OR_就活会議_OR_就活生向け_OR_就活対策用_OR_就活生の情報交換_OR_unistyle_OR_就活の情報共有", "大学生_AND_就活_AND_卒"]],
        ...
        "レスバ_OR_喧嘩",
        ["なりきり（全也）", ["なりきり_OR_全也_OR_nrkr_OR_#也_OR_D也_OR_ゆるなり_OR_緩也_OR_夢也_OR_夢 也_OR_歌い手也_OR_実況者也_OR_全伽羅"]],
        "K也_OR_🇰🇷 也_OR_𝐊 也",
        "女性限定",
        "男性限定",
        "男子限定",
