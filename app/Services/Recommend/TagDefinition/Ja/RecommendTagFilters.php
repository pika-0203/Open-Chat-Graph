...
class RecommendTagFilters
{
    ...
    const FilteredTagSort = [
        ...
        'ポケットモンスター（ポケモン）' => ['ポケモン スカーレット・バイオレット（ポケモンSV）', 'ポケモンGO', 'ポケポケ（Pokémon TCG Pocket）', 'ポケモンユナイト', 'ポケモンカード（ポケカ）', 'ポケモンスリープ', 'ゲーム'],
        'ポケモンGO' => ['ポケモン スカーレット・バイオレット（ポケモンSV）', 'ポケットモンスター（ポケモン）', 'ポケポケ（Pokémon TCG Pocket）', 'ポケモンユナイト', 'ポケモンカード（ポケカ）', 'ポケモンスリープ',],
        'ポケモン スカーレット・バイオレット（ポケモンSV）' => ['ポケモンGO', 'ポケットモンスター（ポケモン）', 'ポケポケ（Pokémon TCG Pocket）', 'ポケモンユナイト', 'ポケモンカード（ポケカ）', 'ポケモンスリープ',],
