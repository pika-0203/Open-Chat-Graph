...
class OpenChatStatisticsRanking
{
     ...
     */
    function getDailyRanking(int $pageNumber, int $limit): array
    {
        return $this->get(
            $pageNumber,
            $limit,
     ...
     * @return array `['pageNumber' => int, 'maxPageNumber' => int, 'openChatList' => array, 'totalRecords' => int]`
     */
    function getPastWeekRanking(int $pageNumber, int $limit): array
    {
        return $this->get(
            $pageNumber,
            $limit,
     ...
     * @return array `['pageNumber' => int, 'maxPageNumber' => int, 'openChatList' => array, 'totalRecords' => int]`
     */
    private function get(int $pageNumber, int $limit, int $totalRecords, \Closure $repository): array
    {
        // ページの最大数を取得する
