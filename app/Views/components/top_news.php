<aside style="font-size: 13px; display: block; margin:0;" class="unset">
    <details style="margin:0 0 0 0; width:100%;">
        <summary class="news-summary">
            <span>アップデート情報</span>
            <span style="color: #b7b7b7; font-weight:normal; font-size:13px"><?php /** @var \App\Views\Content\TopPageNews[] $_news */ echo timeElapsedString($_news[0]->date->format('Y-m-d H:i:s')) ?></span>
        </summary>
