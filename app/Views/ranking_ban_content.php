        ...
        <article>
            ...
            <aside class="list-aside ranking-desc" style="margin: 1rem 0;">
                <details class="icon-desc">
                    ...
                    <p class="recommend-desc">
                        公式の検索機能で検索できないルーム(検索落ち)は、ランキングにも未掲載と考えられます。また、ランキングの掲載は検索に表示されるよりも厳しい条件と考えられます。
                    </p>
                    <p class="recommend-desc">
                        ただし、年齢認証されていない端末による検索・WEB版による検索は、部屋の質について厳しいと考えられますので、全てのパターンが当てはまる訳ではありません。
                        <br>また、年齢認証済であっても、特別に検索ができないキーワードなどがあります。
                    </p>
                    <p class="recommend-desc">
                        これらを踏まえると、ランキング掲載・検索機能(年齢認証有り)・検索機能(年齢認証無し・WEB版)はそれぞれ別々のロジックですが、一部共通する部分があると考える事ができます。
                    </p>
                    <p class="recommend-desc">
                        例外を除くと、例えば、普段はランキングに掲載されていて、検索が可能なルームの場合、そのルームの設定を変更した後に再びランキングに掲載された時が、同時に検索も可能になる時と考えることができます。
                    </p>
                    <p class="recommend-desc">
                        なお、ランキングの掲載が途切れる原因の半数以上は、単純に活動量が低く圏外になるためです。また、ランキングから除外されていると考えられるルームでも、検索は可能なパターンがあります。
                    </p>
                </details>
            </aside>
            <form id="value-form">
