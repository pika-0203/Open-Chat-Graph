...
<body>
    ...
    <div class="pad-side-top-ranking pad-side-top-list body" style="overflow: hidden;">
        ...
        <article class="top-ranking top-btns">
            ...
            <a style="margin: auto; font-size: 13px; color:#111;" href="/labs/cacheclear">【キャッシュの保持時間が長くなる現象の対策】<br>各ページで最新時間のデータが表示されない場合は、こちらのリンクを押してブラウザからオプチャグラフのキャッシュを全て削除できます。</a>
        </article>
        <hr class="hr-bottom">
