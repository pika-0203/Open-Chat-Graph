...
class Metadata
{
    ...
    'オプチャグラフは、オープンチャットの成長傾向を分析したり、コメント機能でディスカッションができる場所です。他のオプチャとの比較が簡単になり、トークルームの利用・運営に役立てることができます。';

    public string $ogpDescription =
    'オプチャグラフは、オプチャの成長傾向を分析したり、コメント機能でディスカッションができる場所です。他のオプチャとの比較が簡単になり、トークルームの利用・運営に役立てることができます。';
