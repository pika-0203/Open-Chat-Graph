...
class TopPageNews
{
    ...
    static function getTopPageNews(): array
    {
        return [
            ...
            new self(
                new \DateTime('2024-05-04 08:25'),
                '分析Labs、オプチャ公式ランキング掲載の分析をリリース【更新】',
                [
                    ...
                    'また、いつ再掲載されたかの履歴が残るため、ルーム内容の変更後にどの位の時間で再掲載されるかの傾向を捉えることができます。',
                    '公式の検索機能で検索できないルーム(検索落ち)は、ランキングにも未掲載と考えることができ、ランキングの掲載は検索に表示されるよりも上位の条件と考えられます。',
                    '例えば、普段はランキングに掲載されているルームであれば、そのルームの内容を変更した後に再びランキングに掲載された時が、同時に検索も可能になる時と考えることができます。',
                    'なお、ランキングの掲載が途切れる原因の半数以上は、単純に活動量が低く圏外になるためです。
                    このような場合、ランキング未掲載でも検索は可能であったりします。
                    また、活動量以外の理由でランキングから除外されていると考えられるルームでも、検索は可能であるパターンがあります。',
                    '最終ランキング順位下位50％以下を除外するオプションを選択することで、活動量以外の原因で未掲載となった可能性が高いルーム一覧を表示できます。',
                    '<b>条件の絞り込み・ページ切り替えを実装しました</b>',
                    '【オープンチャット更新・削除の即時反映】
