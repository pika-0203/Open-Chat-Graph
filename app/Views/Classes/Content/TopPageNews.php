        ...
        return [
            ...
            new self(
                ...
                [
                    ...
                    '現時点で、質の高いコメント投稿により、短い単語の検索キーワードに対しても高い確率で掲載されるようになり、かつ上位の検索順位に掲載されるようになったオープンチャットのエビデンスがいくつかあります。これはGoogleが推奨するSEOに忠実なものです。',
                    ...
                    余談ですが、ChatGPTのようなAIなどで容易に生成できるようなものではなく、曖昧な仕様と複雑なパターン、そして世の中の変化に対応するなど複合的な要素が必要なものです。',
