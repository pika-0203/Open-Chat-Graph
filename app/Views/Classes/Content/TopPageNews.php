        ...
        return [
            ...
            new self(
                ...
                [
                    ...
                    'オプチャグラフは日々ユーザー数・ページビューが増加しており、4月の新規ユーザー数は、3月比の200％以上で一日平均新規ユーザーは600人ほどとなっています。その約8割はGoogle検索からの流入です。さらに、そのうちの2割がルームの参加ボタンを押しています。',
                    ...
                    これは場合により先行者利益を得られる先行投資とも言えるもので、実はこの採用例がまだ少ない新種の構造化データのうち一種類が、オプチャ公式の各ルームのページにも使われています。
                    オプチャグラフはそれを複数の種類で拡張し、そしてGoogleの認識として関連付けされるものとみても差し支えないです。
                    現段階でGoogle検索結果の評価に目に見えてわかるものはありませんが、ルームの人数統計の内容までも新種の構造化データで公式の構造化データとリンクさせてGoogleに認識させています。
                    ...
                    'オープンチャットの良さや体験談、感謝の言葉、建設的なフィードバック、新規参加者へのアドバイスを共有し、良いコミュニティを作りましょう。',
                ]
            ),
        ];
    }
