        ...
        return [
            ...
            new self(
                ...
                [
                    ...
                    オプチャグラフはそれを複数の種類で拡張し、さらにより正しい形式に添削しており、そしてそれは、Googleの認識として公式の構造化データに関連付けされるものとみても差し支えないです。
                    ...
                    この一連の流れは、理想通りに進めば、Googleからの評価として公式のオープンチャットそのもののコンテンツの価値を高めつつ、オプチャグラフの価値も同時に高めることができます。
                    この新種の構造化データの特徴は、先行者利益を得られる先行投資とも言えることです。なぜなら現時点で日本のGoogleのSEOにおいては、明確な効果は見えないものだからです。まだ新しく対応した規格として発表されて間もなく、試験段階と言えるものです。
