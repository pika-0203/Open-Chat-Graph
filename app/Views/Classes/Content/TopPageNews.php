        ...
        return [
            ...
            new self(
                ...
                [
                    ...
                    '少し専門的な内容ですが、このような取り組みをSEOと呼びます。SEOを強化するための設計は、基本的にGoogleが発信している公式の方針に忠実なものとなっています。まだ世界的にも採用例が少ない新しい種類の「構造化データ」の実装など、いくつか挑戦的な取り組みをしています。
                    「構造化データ(Schema.org)」とは、Webページの構造を検索エンジン（Google）により分かりやすく伝えるための専用のコードです。
