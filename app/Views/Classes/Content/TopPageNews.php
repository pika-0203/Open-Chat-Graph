        ...
        return [
            ...
            new self(
                ...
                [
                    ...
                    'この新種の構造化データの特徴は、先行者利益を得られる先行投資とも言えることです。なぜなら現時点で日本のGoogleのSEOにおいては、明確な効果は見えないものだからです。さらに、今この領域で競合に競合がいません。そしてこれは、新しく対応した規格として発表されて間もなく、試験段階と言えるものです。',
                    ...
                    採用を開始してからまだ日が浅く、オプチャグラフで掲載しているルーム15万件のうち、本日時点で2000件ほどが認識されています。これは日に日に増えていき、2,3ヶ月あれば5万件ほどに達する見込みです。
                    この推移や、正しい認識がされているかどうかは、Google Search Console上で日頃確認し、必要に応じて迅速なデバッグを行っています。
                    このような新しい構造化データをオプチャグラフのようなサイトのデータに合わせて生成するプログラムは世の中に無いものですので、全て自前のものとなっています。',
