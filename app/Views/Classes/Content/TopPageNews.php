        ...
        return [
            ...
            new UpdateNews(
                ...
                [
                    ...
                    'また、オプチャグラフは誰でもプログラム開発や設計に参加可能な<a href="https://github.com/pika-0203/Open-Chat-Graph" target="_blank">オープンソースプロジェクト</a>ですが、現状pika-0203個人のコミットで開発されています。
                    オプチャグラフの機能は、オープンチャットの分析専用に新規開発されたものが多く、サイトの裏側でデータ更新や分析を行うプログラムは、複雑なコードで実装されています。',
                    'こちらも課題であり、他の開発者を呼びこむためには、他の開発者が理解しやすいコードに<a href="https://wa3.i-3-i.info/word1494.html" target="_blank">リファクタリング</a>し、わかりやすいドキュメントを作る事が鍵となります。
                    チーム開発をするには、プログラムの可読性を高め、開発・メンテナンスの効率が高いコードにする必要があります。
                    これにより、組織的な開発体制を作ることができれば、オプチャグラフの飛躍に繋がり、オプチャグラフを超えた活動も期待できると考えています。',
                ]
            ),
        ];
    }
