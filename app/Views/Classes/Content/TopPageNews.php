...
class TopPageNews
{
    ...
    static function getTopPageNews(): array
    {
        return [
            ...
            new UpdateNews(
                new \DateTime('2024-05-06 06:15'),
                '広告配信（Google AdSense）を開始',
                [
                    'オプチャグラフは、Google AdSenseによる広告配信を開始しました。',
                    'オプチャグラフの運営経費は、サーバー代や開発環境を維持するために継続的な出費が必要です。この運営資金は、現状<a href="https://github.com/pika-0203" target="_blank">pika-0203</a>が100%賄っています。
                    そこで、運営資金の補填として広告配信を開始しました。',
                    'また、オプチャグラフは誰でもプログラム開発や設計に参加・コピー可能な<a href="https://github.com/pika-0203/Open-Chat-Graph" target="_blank">オープンソースプロジェクト</a>ですが、現状pika-0203個人のみのコミットで維持されています。
                    オプチャグラフの機能は、オープンチャットの分析専用に新規開発されたものが多く、サイトの裏側でデータ更新や分析を行うプログラムは、複雑なコードで実装されています。',
                    'こちらも課題であり、他の開発者を呼びこむためには、チーム開発ができるようにプログラムの可読性を高め、開発・メンテナンスの効率が高いコードに<a href="https://wa3.i-3-i.info/word1494.html" target="_blank">リファクタリング</a>する必要があります。
                    これにより、組織的な開発体制を作ることができれば、オプチャグラフの飛躍に繋がり、オプチャグラフを超えた活動（第三者がオプチャグラフをコピーして改造した新しいプロジェクトなど）も期待できると考えています。',
                ]
            ),
        ];
    }
