        ...
        <main>
            <article class="terms">
                <h1 style="letter-spacing: 0px;">
                    <svg style="color: #111; fill: currentColor; display: inline-block; margin-right: 4px; margin-bottom: -4px; margin-left: -24px;" focusable="false" height="24px" viewBox="0 -960 960 960" width="24px">
                ...
                <p>この分析機能は、全ルームの履歴を、ルーム内容の変更の有無や再掲載の有無に基づいて絞り込み表示することが可能です。
                    <br>ルームの集客にとって重要な公式ランキングの可視性の傾向を分析することができます。
                </p>
