...
<body>
    ...
    <main style="overflow: hidden;">
        <article class="terms">
            ...
            <h2 style="font-size: 15px;">Issue</h2>
            <section style="margin: 0;">
                <p>
                    現状に対して改善すべき点の指摘(機能以外についても、改善が望ましい点)、機能追加・機能改善の要望や提案、バグの報告などは、<a href="https://github.com/pika-0203/Open-Chat-Graph" target="_blank">GitHubリポジトリ</a>にてIssueを作成してください。
                </p>
            </section>
            <!-- <h2>オプチャグラフ公開の経緯</h2>
            <p>
