    ...
    <main style="overflow: hidden;">
        <article class="terms">
            ...
            <?php elseif (\Shared\MimimalCmsConfig::$urlRoot === '/th') : ?>
                <h1 style="letter-spacing: 0px;">เกี่ยวกับ โอเพนแชท กราฟ</h1>
                <p>โอเพนแชท กราฟ เป็นเว็บไซต์ที่ช่วยให้ผู้ใช้ค้นหา โอเพนแชท และเปรียบเทียบแนวโน้มการเติบโตผ่านกราฟและการจัดอันดับ</p>
                ...
                <p>
                    โอเพนแชท กราฟ สร้างกราฟและการจัดอันดับโดยใช้ข้อมูลจาก「<a href="https://openchat.line.me/jp" rel="external" target="_blank">เว็บไซต์ทางการของ LINE OpenChat</a>」
                </p>
                <p>
                    เพื่อแสดงข้อมูลล่าสุด โอเพนแชท กราฟ ใช้<a href="https://webtan.impress.co.jp/g/%E3%82%AF%E3%83%AD%E3%83%BC%E3%83%A9%E3%83%BC" target="_blank">โปรแกรมรวบรวมข้อมูล (Crawler)</a> ในการเยี่ยมชมเว็บไซต์ทางการเป็นประจำและบันทึกข้อมูล โอเพนแชท
                </p>
                <p>
                    <b>ข้อมูลจะถูกรวบรวมจากเว็บไซต์ทางการเท่านั้น จะไม่มีการรวบรวมข้อมูลจากตัวแอปพลิเคชัน LINE</b>
                </p>
                <section style="margin: 2rem 0;">
                    <h3 style="font-size: 14px;">เงื่อนไขการรวบรวมข้อมูลใน โอเพนแชท กราฟ</h3>
                    <p>
                        โปรแกรมรวบรวมข้อมูลของ โอเพนแชท กราฟ ค้นหาและลงทะเบียนห้องใหม่จาก<a href="https://openchat.line.me/jp/explore?sort=RANKING" rel="external" target="_blank">การจัดอันดับบนเว็บไซต์ทางการ</a> <b>ห้องที่ไม่ได้อยู่ในการจัดอันดับจะไม่ได้รับการลงทะเบียน</b>
                    </p>
                    <p>
                        ห้องที่ได้รับการลงทะเบียนใน โอเพนแชท กราฟ แล้ว จะยังคงแสดงอยู่ใน โอเพนแชท กราฟ แม้ว่าจะไม่มีในอันดับ
                    </p>
                    <p>
                        หากห้องถูกลบหรือหยุดแสดงในเว็บไซต์ทางการ ห้องดังกล่าวจะถูกลบออกจาก โอเพนแชท กราฟ ด้วย
                    </p>
                    <p>
                        ห้องที่ไม่ได้อยู่ในการจัดอันดับ (เช่น ห้องที่เพิ่งสร้าง) สามารถลงทะเบียนใน โอเพนแชท กราฟ ได้ด้วยตนเองหากอยู่ในเว็บไซต์ทางการ
                    </p>
                </section>
                <section style="margin: 2rem 0;">
                    <h3 style="font-size: 14px;">กำหนดการอัปเดตข้อมูล</h3>
                    <p>
                        โปรแกรมรวบรวมข้อมูลของ โอเพนแชท กราฟ เยี่ยมชมเว็บไซต์ทางการเป็นประจำเพื่ออัปเดตข้อมูล เช่น ชื่อห้อง คำอธิบาย รูปภาพ สถิติสมาชิก ประวัติการจัดอันดับ ฯลฯ
                    </p>
                    <ul style="font-size: 14px; line-height: 2;">
                ...
                <section style="margin: 2rem 0;">
                    ...
                    <p>
                        โปรแกรมรวบรวมข้อมูลของ โอเพนแชท กราฟ บันทึกอันดับการจัดอันดับบนเว็บไซต์ทางการทุกชั่วโมง โดยคำนวณอันดับจากลำดับของห้อง
                    </p>
                    <p>
