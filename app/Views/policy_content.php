    ...
    <div class="body">
        ...
        <main>
            <article class="terms">
                ...
                <p>
                    オプチャグラフは「<a href="https://openchat.line.me/jp" rel="external" target="_blank">LINE公式サイト</a>」からオープンチャットのデータをインデックス（記録）し、視覚的に見やすいグラフやランキング形式として表示しています。
                </p>
                <p>
                ...
                <p>
                    オプチャグラフが提供するキーワード検索機能は、LINE公式サイトからインデックスした最新の情報に基づいています。Google・Yahoo・Bingなどの検索エンジンが表示する検索結果と同様の内容です。
                </p>
                <p>
                    LINE公式のキーワード検索機能とオプチャグラフはリンクしておらず、異なるものです。オプチャグラフがLINE公式の検索機能からデータを取得することはありません。
                </p>
                <p>
                ...
                <p>
                    しかし、2023年10月頃に<a href="https://openchat.line.me/jp" target="_blank">「WEBブラウザ版メイン画面」（LINE公式サイト）</a>が公開された事により、LINEアプリ外のブラウザからオープンチャットを検索したり、ランキングを見ることが可能になりました。参加経路の拡大を図るため、「WEBブラウザ版メイン画面」に掲載されているオープンチャットを検索エンジン（Googleなど）の検索結果に表示させるというものです。
                ...
                <p>
                    ...
                    オプチャグラフの<a href="https://webtan.impress.co.jp/g/%E3%82%AF%E3%83%AD%E3%83%BC%E3%83%A9%E3%83%BC" target="_blank">クローラー</a>がLINE公式サイトのデータをクローリングし、Google・Bingなどの検索エンジンと同様の一般的なルールに基づいてデータを公開しています。
                </p>
                <p>
                    オープンチャットのデータを不正に公開するものではなく、適切な範囲内で健全な情報共有を行うWEBサイトです。
                    例えば、ランキングの順位はデータの並び順をカウントしてそのまま順位として表示したものであり、誰でもLINE公式サイトで見ることができる情報に過ぎません。
                </p>
                <p>
