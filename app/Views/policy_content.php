    ...
    <div class="body">
        ...
        <main>
            <article class="terms">
                ...
                <p>オプチャグラフはユーザーがオープンチャットを見つけて、成長傾向をグラフで比較できる場所です。</p>
                <p><a href="https://github.com/pika-0203/Open-Chat-Graph" target="_blank">オープンソースプロジェクト</a>により運営されているLINE非公式のWEBサイトです。 </p>
                <h2>サイトの目的</h2>
                ...
                <p>
                    最新データを表示するため、1時間ごとにオプチャグラフの<a href="https://webtan.impress.co.jp/g/%E3%82%AF%E3%83%AD%E3%83%BC%E3%83%A9%E3%83%BC" target="_blank">クローラー（巡回プログラム）</a>が公式サイトを巡回し、オープンチャットのデータをインデックス（記録）しています。
                </p>
                <p>
                ...
                <section style="margin: 2rem 0;">
                    ...
                    <p>
                        ただし、一度オプチャグラフに登録されたルームはランキングに未掲載であっても、公式サイトにルームのページが掲載されていて、ルームが削除されていなければ、オプチャグラフでも掲載が続きます。
                    </p>
                    <p>
