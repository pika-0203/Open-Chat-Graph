    ...
    <div class="body">
        ...
        <main>
            <article class="terms">
                ...
                <p>
                    オプチャグラフでは<a href="https://openchat.line.me/jp/explore?sort=RANKING" rel="external" target="_blank">公式ランキング（LINE公式サイト）</a>からオープンチャットのデータをインデックス（記録）し、視覚的に見やすいグラフやランキング形式として表示しています。
                    <br>常に最新データを表示するため、1時間ごとに<a href="https://webtan.impress.co.jp/g/%E3%82%AF%E3%83%AD%E3%83%BC%E3%83%A9%E3%83%BC" target="_blank">クローラー</a>が公式サイトを巡回してオプチャグラフで記録している情報を更新しています。
                </p>
                <p>
                    公式サイトにて掲載が終了・削除されたオープンチャットはオプチャグラフからも48時間以内に削除されます。
                </p>
                ...
                <p>
                    しかし、2023年10月頃に<a href="https://openchat.line.me/jp" target="_blank">「WEBブラウザ版メイン画面」（オプチャ公式サイト）</a>が公開された事により、LINEアプリ外のブラウザからオープンチャットを検索したり、ランキングを見ることが可能になりました。参加経路の拡大を図るため、「WEBブラウザ版メイン画面」に掲載されているオープンチャットを検索エンジン（Googleなど）の検索結果に表示させるというものです。
                    <a href="https://ja.wikipedia.org/wiki/%E6%A4%9C%E7%B4%A2%E3%82%A8%E3%83%B3%E3%82%B8%E3%83%B3%E6%9C%80%E9%81%A9%E5%8C%96" target="_blank">SEO</a>と言われるマーケティングの一環により、効果的に掲載を図りユーザーの認知を増やすことを目的とした媒体であると考えられます。
                </p>
                <p>
                </p>
                <p>
                    <b>オプチャグラフは「WEBブラウザ版メイン画面」の分析データを掲載し、参加経路拡大に寄与するために開発されたオープンチャット専用の検索エンジンです。</b>
                    <a href="https://webtan.impress.co.jp/g/%E3%82%AF%E3%83%AD%E3%83%BC%E3%83%A9%E3%83%BC" target="_blank">クローラー</a>でオプチャ公式サイトのデータをクローリングし、Google・Bingなどの検索エンジンと同様の一般的なルールに基づいてデータを公開しています。
                </p>
                <p>
