    ...
    <div class="body">
        ...
        <main>
            <article class="terms">
                ...
                <p>
                    しかし、2023年10月頃に<a href="https://openchat.line.me/jp" target="_blank">「WEBブラウザ版メイン画面」（オプチャ公式サイト）</a>が公開された事により、LINEアプリ外のブラウザからオープンチャットを検索したり、ランキングを見ることが可能になりました。「WEBブラウザ版メイン画面」に掲載されているオープンチャットが、検索エンジン（Googleなど）の検索結果に表示されることで、参加経路の拡大を図るものです。
