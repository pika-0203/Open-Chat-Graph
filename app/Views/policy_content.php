    ...
    <div class="body">
        ...
        <main>
            <article class="terms">
                ...
                <p>
                    最新データを表示するため、1時間ごとに<a href="https://webtan.impress.co.jp/g/%E3%82%AF%E3%83%AD%E3%83%BC%E3%83%A9%E3%83%BC" target="_blank">クローラー（巡回プログラム）</a>が公式サイトを巡回し、オープンチャットのデータをインデックス（記録）します。
                </p>
                <p>
