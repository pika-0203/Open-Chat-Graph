    ...
    <div class="body">
        ...
        <main>
            <article class="terms">
                ...
                <p>公式サイトが送信しているオープンチャットの情報を保存・分析し、視覚的に見やすいグラフやランキングにして提供しています。</p>
                <p>なお、公式サイトにて掲載が終了・削除されたオープンチャットはオプチャグラフからも最大48時間以内に削除されます。</p>
                <p style="font-size: 12px; color: #777;" id="comments">LINE公式サイトでの掲載条件は非公開となっています。</p>
